    ...
    std::string message(int c) const override final
    {
        switch (static_cast<orm_error_code>(c)) {
            ...
            case orm_error_code::cannot_use_default_value:
                return "The statement 'INSERT INTO * DEFAULT VALUES' can be "
                       "used with "
                       "only one row";
...
std::string get_error_message(sqlite3* db, T&&... args)
{
    ...
    static_cast<void>(unpack {
        0, (static_cast<void>(static_cast<void>(stream << args)), 0)...});
...
struct has_some_type<TT, std::tuple<U, Ts...>>
    : has_some_type<TT, std::tuple<Ts...>>
{
};
...
struct iterator_impl
{
    ...
    void operator()(const L& lambda)
    {
        ...
        lambda((const typename std::tuple_element<N - 1, std::tuple<Args...>>::
                    type*)nullptr);
    }
};
...
struct iterator_impl<0, Args...>
{
    ...
    void operator()(const L& lambda)
    {
        lambda((const typename std::tuple_element<0, std::tuple<Args...>>::
                    type*)nullptr);
    }
};
...
auto call(Function& f, FunctionPointer functionPointer, Tuple t)
{
    ...
    return call_impl(
        f, functionPointer, move(t), std::make_index_sequence<size> {});
}
...
void move_tuple(L& lhs, R& rhs)
{
    ...
    static_if<bool_type {}>([](auto& l, auto& r)
                            { move_tuple_impl<N, 0>(l, r); })(lhs, rhs);
}
...
void iterate_tuple(const std::tuple<Args...>& tuple, const L& lambda)
{
    ...
    tuple_helper::iterator_impl<std::tuple_size<tuple_type>::value - 1,
                                Args...>()(tuple, lambda, false);
}
...
struct find_in_tuple<std::tuple<H, Args...>,
                     C,
                     typename std::enable_if<C<H>::value>::type>
{
    using type = H;
};
...
struct on_update_delete_t : on_update_delete_base
{
    ...
    on_update_delete_t(decltype(fk) fk_,
                       decltype(update) update_,
                       foreign_key_action action_)
        : on_update_delete_base {update_}
        , fk(fk_)
        , _action(action_)
    {
    }
...
struct foreign_key_t<std::tuple<Cs...>, std::tuple<Rs...>>
{
     ...
     */
    using target_type =
        typename same_or_void<typename table_type<Rs>::type...>::type;

    /**
     * Holds obect type of all source columns.
     */
    using source_type =
        typename same_or_void<typename table_type<Cs>::type...>::type;
...
struct is_primary_key_insertable
{
    ...
    static_assert((tuple_helper::tuple_contains_type<primary_key_t<>,
                                                     constraints_type>::value),
                  "an unexpected type was passed");

    static constexpr bool value =
        (tuple_helper::tuple_contains_some_type<default_t,
                                                constraints_type>::value
         || tuple_helper::tuple_contains_type<autoincrement_t,
                                              constraints_type>::value
 ...
 */
template<class L, class R>
using bitwise_shift_right_t = binary_operator<L,
                                              R,
...
struct column_t : column_base
{
    ...
    std::unique_ptr<std::string> default_value() const
    {
        ...
        iterate_tuple(this->constraints,
                      [&res](auto& v)
                      {
...
// we are compelled to wrap all sfinae-implemented traits to prevent "error:
...
struct is_column_with_insertable_primary_key<
    column_t<O, T, Op...>,
    typename std::enable_if<(
        tuple_helper::tuple_contains_type<
            primary_key_t<>,
            ...
            typename column_t<O, T, Op...>::constraints_type>::value)>::type>
{
    using column_type = column_t<O, T, Op...>;
    static constexpr bool value =
        !is_primary_key_insertable<column_type>::value;
};
...
template<class T>
struct is_column_with_insertable_primary_key
    : public sfinae::is_column_with_insertable_primary_key<T>
{
};
...
template<class T>
struct is_column_with_noninsertable_primary_key
    : public sfinae::is_column_with_noninsertable_primary_key<T>
{
};
...
struct expression_t : condition_t
{
    ...
    {
        return {
            this->value, std::make_tuple(std::forward<Args>(args)...), false};
    }
    ...
    {
        return {
            this->value, std::make_tuple(std::forward<Args>(args)...), true};
    }
...
struct named_collate : named_collate_base
{
    ...
    named_collate(T expr_, std::string name_)
        : named_collate_base {std::move(name_)}
        , expr(std::move(expr_))
    {
    }
};
 ...
 */
template<class C>
struct negated_condition_t
    : condition_t
    , negated_condition_string
{
    C c;
...
template<class L, class R>
struct is_equal_t
    : binary_condition<L, R, is_equal_string, bool>
    , negatable_t
{
...
struct is_not_equal_t
    : binary_condition<L, R, is_not_equal_string, bool>
    , negatable_t
{
...
struct greater_than_t
    : binary_condition<L, R, greater_than_string, bool>
    , negatable_t
{
    ...
    , negatable_t
{
    ...
    using binary_condition<L, R, greater_or_equal_string, bool>::
        binary_condition;
 ...
 */
template<class L, class R>
struct lesser_than_t
    : binary_condition<L, R, lesser_than_string, bool>
    , negatable_t
{
 ...
 */
template<class L, class R>
struct lesser_or_equal_t
    : binary_condition<L, R, lesser_or_equal_string, bool>
    , negatable_t
{
    using self = lesser_or_equal_t<L, R>;

    using binary_condition<L, R, lesser_or_equal_string, bool>::
        binary_condition;
...
struct order_by_base
{
    ...
    order_by_base(decltype(asc_desc) asc_desc_,
        ...
        : asc_desc(asc_desc_)
        , _collate_argument(move(_collate_argument_))
    {
    }
};
    ...
    , order_by_string
{
    ...
    self collate_binary() const
    {
        ...
        res._collate_argument =
            collate_constraint_t::string_from_collate_argument(
...
struct dynamic_order_by_entry_t : order_by_base
{
    ...
    dynamic_order_by_entry_t(decltype(name) name_,
                             int asc_desc_,
                             std::string collate_argument_)
        : order_by_base {asc_desc_, move(collate_argument_)}
        , name(move(name_))
    {
    }
};
...
struct dynamic_order_by_t : order_by_string
{
    ...
    void push_back(order_by_t<O> order_by)
    {
        ...
        entries.emplace_back(move(columnName),
                             order_by.asc_desc,
    ...
    , negatable_t
{
    ...
    like_t<A, T, C> escape(C c) const
    {
        ...
        return {
            std::move(this->arg), std::move(this->pattern), std::move(newArg3)};
    }
};
...
template<class T, class R>
internal::lesser_or_equal_t<T, R> operator<=(internal::expression_t<T> expr,
                                             R r)
{
    return {std::move(expr.value), std::move(r)};
}
...
template<class L, class T>
internal::lesser_or_equal_t<L, T> operator<=(L l,
...
template<class T, class R>
internal::greater_or_equal_t<T, R> operator>=(internal::expression_t<T> expr,
                                              R r)
{
    return {std::move(expr.value), std::move(r)};
}
...
template<class L, class T>
internal::greater_or_equal_t<L, T> operator>=(L l,
                                              internal::expression_t<T> expr)
{
    return {std::move(l), std::move(expr.value)};
}
...
template<class T, class O>
typename std::enable_if<!internal::is_offset<T>::value,
...
template<class F,
         ...
         typename = typename std::enable_if<internal::is_base_of_template<
             F,
             internal::built_in_function_t>::value>::type>
...
typename std::enable_if<
    internal::count_tuple<std::tuple<X, Y, Z>, internal::is_into>::value == 0,
    internal::
        built_in_function_t<std::string, internal::replace_string, X, Y, Z>>::
    type
    replace(X x, Y y, Z z)
{
...
internal::built_in_function_t<R, internal::coalesce_string, Args...> coalesce(
    Args... args)
{
    return {std::make_tuple(std::forward<Args>(args)...)};
}
 ...
 */
template<class X>
internal::built_in_function_t<std::unique_ptr<double>, internal::sum_string, X>
sum(X x)
{
    return {std::tuple<X> {std::forward<X>(x)}};
}
 ...
 */
template<class X>
internal::built_in_function_t<std::string, internal::group_concat_string, X>
group_concat(X x)
{
    return {std::tuple<X> {std::forward<X>(x)}};
}
 ...
 */
template<class X, class Y>
internal::built_in_function_t<std::string, internal::group_concat_string, X, Y>
...
{
    return {std::tuple<X, Args...> {std::forward<X>(x),
                                    std::forward<Args>(args)...}};
}

template<class X, class... Args>
internal::
    built_in_function_t<std::string, internal::json_insert_string, X, Args...>
...
template<class X, class... Args>
internal::
    built_in_function_t<std::string, internal::json_replace_string, X, Args...>
...
template<class X, class... Args>
internal::
    built_in_function_t<std::string, internal::json_set_string, X, Args...>
...
template<class... Args>
internal::
    built_in_function_t<std::string, internal::json_object_string, Args...>
...
template<class X, class... Args>
internal::
    built_in_function_t<std::string, internal::json_remove_string, X, Args...>
...
template<class X, class Y>
internal::
    built_in_function_t<std::string, internal::json_group_object_string, X, Y>
    ...
    , union_base
{
    ...
    union_t(left_type l, right_type r, decltype(all) all_)
        : compound_operator<L, R>(std::move(l), std::move(r))
        , union_base {all_}
    {
    }
...
struct simple_case_builder
{
                                                                 ...
                                                                 then_t<Th> t)
    {
        ...
        std::get<std::tuple_size<result_args_type>::value - 1>(result_args) =
            std::move(newPair);
        return {std::move(this->case_expression),
...
struct statement_binder<V, std::enable_if_t<std::is_arithmetic<V>::value>>
{
  ...
  private:
    ...
    void result(sqlite3_context* context,
                const V& value,
                const int_or_smaller_tag&) const
    {
                     ...
                     || std::is_same<V, const char*>::value>>
{
    int bind(sqlite3_stmt* stmt, int index, const V& value) const
    {
        ...
        return sqlite3_bind_text(stmt,
                                 index,
                                 std::get<0>(stringData),
                                 std::get<1>(stringData),
                                 SQLITE_TRANSIENT);
    }
                     ...
                     || std::is_same<V, const wchar_t*>::value>>
{
    ...
    void result(sqlite3_context* context, const V& value) const
    {
        sqlite3_result_text16(
            context, (const void*)value.data(), int(value.length()), nullptr);
    }
};
#endif  //  SQLITE_ORM_OMITS_CODECVT
...
struct statement_binder<V, std::enable_if_t<is_std_ptr<V>::value>>
{
    ...
    int bind(sqlite3_stmt* stmt, int index, const V& value) const
    {
        if (value) {
            ...
            return statement_binder<std::nullptr_t>().bind(
                stmt, index, nullptr);
        }
    }
...
struct statement_binder<std::optional<T>, void>
{
    ...
    int bind(sqlite3_stmt* stmt, int index, const std::optional<T>& value) const
    {
        if (value) {
            ...
            return statement_binder<std::nullopt_t>().bind(
                stmt, index, std::nullopt);
        }
    }
...
struct tuple_filter<std::tuple<Args...>, F>
{
    using type = typename conc_tuple<
        typename tuple_filter_single<Args, F>::type...>::type;
};
...
{
    using type = typename conc_tuple<
        typename bindable_filter_single<Args>::type...>::type;
};
}  // namespace internal
}  // namespace sqlite_orm
#pragma once
...
struct row_extractor<V, std::enable_if_t<is_std_ptr<V>::value>>
{
    ...
    V extract(sqlite3_value* value) const
    {
        ...
        if (type != SQLITE_NULL) {
            return is_std_ptr<V>::make(
                row_extractor<value_type>().extract(value));
        } else {
            return {};
        }
    }
...
inline auto call_insert_impl_and_catch_constraint_failed(const T& insert_impl)
{
    try {
        ...
        if (e.code()
            == std::error_code(SQLITE_CONSTRAINT, get_sqlite_error_category()))
        {
            std::stringstream ss;
            ss << "Attempting to execute 'insert' request resulted in an error "
                  "like "
                  "\""
               << e.what()
               << "\". Perhaps ordinary 'insert' is not acceptable for this "
                  "table "
                  "and you should try "
...
enum class sync_schema_result
{
     ...
     *      1. delete excess columns in the table than storage if preseve =
     * false
...
{
    return {
        name, false, std::make_tuple(internal::make_indexed_column(cols)...)};
}
...
{
    return {
        name, true, std::make_tuple(internal::make_indexed_column(cols)...)};
}
}  // namespace sqlite_orm
#pragma once
...
struct table_types<table_t<T, Args...>>
{
    ...
    using type =
        typename tuple_transformer<columns_tuple, column_field_type>::type;
};
...
struct column_foreign_keys_count<foreign_key_t<A, B>, O>
{
    ...
    static constexpr const int value =
        std::is_same<O, target_type>::value ? 1 : 0;
};
...
{
    static constexpr const int value = column_foreign_keys_count<H, O>::value
        + table_foreign_keys_count_impl<O, Tail...>::value;
};

/**
 *  T is table_t type
 *  O is object type which is the reference target (e.g.
 * foreign_key(&Visit::userId).references(&User::id) has O = User)
 */
template<class T, class O>
...
struct table_foreign_keys_count<table_t<T, Cs...>, O>
{
    ...
    static constexpr const int value =
        table_foreign_keys_count_impl<O, Cs...>::value;
};
...
template<class O>
struct storage_foreign_keys_count_impl<storage_impl<>, O>
    : std::integral_constant<int, 0>
{
};
...
struct storage_foreign_keys_count
{
    ...
    static constexpr const int value =
        storage_foreign_keys_count_impl<impl_type, O>::value;
};
...
struct column_fk_references<
    ...
    typename std::enable_if<
        std::is_same<O,
                     typename foreign_key_t<A, B>::target_type>::value>::type>
{
...
struct storage_fk_references_impl<storage_impl<H, Ts...>, O>
{
    ...
    using tail_tuple =
        typename storage_fk_references_impl<storage_impl<Ts...>, O>::type;
    using type = typename conc_tuple<head_tuple, tail_tuple>::type;
};
...
{
    using func_call = std::function<void(sqlite3_context* context,
...
template<class F>
struct is_scalar_function
    : std::integral_constant<bool, is_scalar_function_impl<F>::has>
{
};

template<class F>
struct is_aggregate_function
    : std::integral_constant<bool, is_aggregate_function_impl<F>::has_both>
{
};
...
struct callable_arguments_impl<F, true>
{
    ...
    using args_tuple =
        typename member_function_arguments<function_member_pointer>::tuple_type;
    using return_type = typename member_function_arguments<
        function_member_pointer>::return_type;
};

template<class F>
struct callable_arguments_impl<F, false>
{
    using step_function_member_pointer =
        typename aggregate_run_member_pointer<F>::step_type;
    using fin_function_member_pointer =
        typename aggregate_run_member_pointer<F>::fin_type;
    using args_tuple = typename member_function_arguments<
        step_function_member_pointer>::tuple_type;
    using return_type = typename member_function_arguments<
        fin_function_member_pointer>::return_type;
};

template<class F>
struct callable_arguments
    : callable_arguments_impl<F, is_scalar_function<F>::value>
{
};
...
struct column_result_t<
    St,
    built_in_function_t<internal::unique_ptr_result_of<X>, S, X>,
    void>
{
...
struct table_template : table_base<_without_rowid>
{
    ...
    const F* get_object_field_pointer(const object_type& obj, C c) const
    {
        ...
        this->for_each_column_with_field_type<F>(
            ...
            {
                using column_type =
                    typename std::remove_reference<decltype(col)>::type;
                using member_pointer_t = typename column_type::member_pointer_t;
                using getter_type = typename column_type::getter_type;
                using setter_type = typename column_type::setter_type;
                // Make static_if have at least one input as a workaround for
                // GCC bug: https://gcc.gnu.org/bugzilla/show_bug.cgi?id=64095
                if (!res) {
    ...
    /**
     *  Searches column name by class member pointer passed as the first
     * argument.
    ...
    const std::string* find_column_name(F O::*m) const
    {
        ...
        this->template for_each_column_with_field_type<F>(
            [&res, m](auto& c)
            {
     ...
     */
    template<class G>
    const std::string* find_column_name(
        G getter,
     ...
     * constraints (e.g. foreign_key_t) at the end of the columns list. To
     * iterate columns with table constraints use iterate_tuple(columns, ...)
    ...
    void for_each_column(const L& l) const
    {
        iterate_tuple(this->columns,
                      ...
                      {
                          using column_type =
                              typename std::decay<decltype(column)>::type;
        ...
        iterate_tuple(this->columns,
                      [&l](auto& column)
                      {
                          using column_type =
                              typename std::decay<decltype(column)>::type;
                          using field_type =
                              typename column_field_type<column_type>::type;
    ...
    void for_each_column_with(const L& l) const
    {
        ...
        iterate_tuple(
            ...
            [&l](auto& column)
            {
                ...
                static_if<tuple_contains_type<Op, constraints_type> {}>(l)(
                    column);
            });
    }
    ...
    std::vector<table_info> get_table_info() const
    {
        ...
        this->for_each_column(
            [&res](auto& col)
            {
                std::string dft;
                using field_type =
                    typename std::decay<decltype(col)>::type::field_type;
...
struct storage_impl_base
{
    ...
    static bool calculate_remove_add_columns(
...
struct storage_impl<H, Ts...> : public storage_impl<Ts...>
{
     ...
     *  `column_name` has SFINAE check for type equality but
     * `column_name_simple` has not.
     */
    template<class O, class F>
     ...
     *  Performs CREATE TABLE %name% AS SELECT %this->table.columns_names()%
                    ...
                    const std::vector<table_info*>& columnsToIgnore) const
    {
        ...
        this->table.for_each_column(
            [&columnNames, &columnsToIgnore](auto& c)
            {
    ...
    sync_schema_result schema_status(sqlite3* db, bool preserve) const
    {
        ...
        if (!gottaCreateTable) {
            ...
            //  this vector will contain pointers to columns that gotta be
            //  added..
            std::vector<table_info*> columnsToAdd;

            if (this->calculate_remove_add_columns(
                    columnsToAdd, storageTableInfo, dbTableInfo))
            {
                gottaCreateTable = true;
            }

            if (!gottaCreateTable) {  //  if all storage columns are equal to
                                      //  actual db columns but there are
            ...
            if (gottaCreateTable) {
                ...
                if (columnsToAdd.size()) {
                    ...
                    for (auto columnPointer : columnsToAdd) {
                        if (columnPointer->notnull
                            && columnPointer->dflt_value.empty()) {
                            gottaCreateTable = true;
                            break;
                        }
                    }
...
struct object_from_column_builder : object_from_column_builder_base
{
    ...
    object_from_column_builder(object_type& object_, sqlite3_stmt* stmt_)
        : object_from_column_builder_base {stmt_}
        , object(object_)
    {
    }
    ...
    void operator()(const C& c) const
    {
        ...
        auto value =
            row_extractor<field_type>().extract(this->stmt, this->index++);
        if (c.member_pointer) {
...
struct iterator_t
{
  ...
  public:
    ...
    iterator_t(sqlite3_stmt* stmt_, view_type& view_)
        : stmt(std::make_shared<statement_finalizer>(stmt_))
        , view(&view_)
    {
        next();
    }
...
struct connection_holder
{
    ...
    void retain()
    {
        ...
        if (1 == this->_retain_count) {
            ...
            if (rc != SQLITE_OK) {
                throw std::system_error(
                    std::error_code(sqlite3_errcode(this->db),
                                    get_sqlite_error_category()),
...
internal::insert_raw_t<Args...> insert(Args... args)
{
    ...
    static_assert(argsCount
                      == intoArgsCount + columnsArgsCount + valuesArgsCount
                          + defaultValuesCount + selectsArgsCount + orArgsCount
                          + upsertClausesCount,
...
internal::replace_raw_t<Args...> replace(Args... args)
{
    ...
    static_assert(argsCount
                      == intoArgsCount + columnsArgsCount + valuesArgsCount
                          + defaultValuesCount + selectsArgsCount,
 ...
 */
template<class It>
internal::replace_range_t<It,
                          internal::default_transformer,
...
/**
 *  Create an replace range statement with explicit transformer. Transformer is
 * used to apply containers with no strict objects with other kind of objects
 * like pointers, optionals or whatever.
 *  @example
 *  ```
 *  std::vector<std::unique_ptr<User>> userPointers;
 *  userPointers.push_back(std::make_unique<User>(1, "Eneli"));
 *  auto statement = storage.prepare(replace_range<User>(userPointers.begin(),
 * userPointers.end(), [](const std::unique_ptr<User> &userPointer) -> const
 * User & { return *userPointer;
 *  }));
 *  storage.execute(statement);
 *  ```
 */
...
/**
 *  Create an insert range statement with explicit transformer. Transformer is
 * used to apply containers with no strict objects with other kind of objects
 * like pointers, optionals or whatever.
 *  @example
 *  ```
 *  std::vector<std::unique_ptr<User>> userPointers;
 *  userPointers.push_back(std::make_unique<User>(1, "Eneli"));
 *  auto statement = storage.prepare(insert_range<User>(userPointers.begin(),
 * userPointers.end(), [](const std::unique_ptr<User> &userPointer) -> const
 * User & { return *userPointer;
 *  }));
 *  storage.execute(statement);
 ...
 */
template<class T, class... Cols>
internal::insert_explicit<T, Cols...> insert(T obj,
...
struct conflict_target
{
    ...
    {
        return {std::move(this->args),
                {std::make_tuple(std::forward<ActionsArgs>(actions)...)}};
    }
};
...
template<class... TargetArgs, class... ActionsArgs>
struct ast_iterator<
    upsert_clause<std::tuple<TargetArgs...>, std::tuple<ActionsArgs...>>,
    void>
{
    using node_type =
        upsert_clause<std::tuple<TargetArgs...>, std::tuple<ActionsArgs...>>;
...
struct view_t
{
    ...
    iterator_t<self> begin()
    {
        ...
        using context_t =
            serializator_context<typename storage_type::impl_type>;
        ...
        if (ret == SQLITE_OK) {
            ...
            iterate_ast(
                ...
                [&index, stmt, db](auto& node)
                {
                    ...
                    conditional_binder<node_type, is_bindable<node_type>>
                        binder {stmt, index};
...
template<>
inline int getPragmaCallback<std::vector<std::string>>(void* data,
                                                       int argc,
                                                       char** argv,
                                                       char**)
{
...
struct pragma_t
{
  ...
  private:
    ...
    T get_pragma(const std::string& name)
    {
        ...
        auto rc = sqlite3_exec(
            db, query.c_str(), getPragmaCallback<T>, &result, nullptr);
        if (rc == SQLITE_OK) {
            return result;
        } else {
            throw std::system_error(
    ...
    /**
     *  Yevgeniy Zakharov: I wanted to refactor this function with statements
     * and value bindings but it turns out that bindings in pragma statements
     * are not supported.
     */
    template<class T>
...
struct backup_t
{
    backup_t(connection_ref to_,
        ...
        : handle(sqlite3_backup_init(
            to_.get(), zDestName.c_str(), from_.get(), zSourceName.c_str()))
        , to(to_)
        , from(from_)
        , holder(move(holder_))
    {
...
struct arg_values
{
    ...
    arg_value operator[](int index) const
    {
        if (index < this->argsCount && index >= 0) {
            ...
            throw std::system_error(
                std::make_error_code(orm_error_code::index_is_out_of_bounds));
        }
    }
 ...
 *  I is index to extract value from values C array to tuple. I must me <
...
{
    void extract(sqlite3_value** values,
                 std::tuple<arg_values>& tuple,
                 int argsCount) const
    {
...
struct storage_base
{
    ...
    transaction_guard_t transaction_guard()
    {
        ...
        auto rollbackFunc = std::bind(
            static_cast<void (storage_base::*)()>(&storage_base::rollback),
            this);
    ...
    /**
     *  Returns existing permanent table names in database. Doesn't check
     * storage itself - works only with actual database.
    ...
    /**
     * Call this to create user defined scalar function. Can be called at any
     * time no matter connection is opened or no. T - function class. T must
     * have operator() overload and static name function like this:
     * ```
     *  struct SqrtFunction {
     *
    ...
    {
        static_assert(is_scalar_function<F>::value,
                      "F cannot be a scalar function");
        ...
        this->scalarFunctions.emplace_back(new scalar_function_t {
               ...
               sqlite3_value** values)
            {
                ...
                values_to_tuple<args_tuple, tuple_size::value - 1>().extract(
                    values, argsTuple, argsCount);
        ...
        if (this->connection->retain_count() > 0) {
            ...
            try_to_create_function(
                db,
                static_cast<scalar_function_t&>(*this->scalarFunctions.back()));
        }
    }
     ...
     * time no matter connection is opened or no. T - function class. T must
     * have step member function, fin member function and static name function
     * like this:
     * ```
     *   struct MeanFunction {
     *       double total = 0;
    ...
    {
        static_assert(is_aggregate_function<F>::value,
                      "F cannot be an aggregate function");
        ...
        if (this->connection->retain_count() > 0) {
            ...
            try_to_create_function(db,
                                   static_cast<aggregate_function_t&>(
                                       *this->aggregateFunctions.back()));
        }
    }

    /**
     *  Use it to delete scalar function you created before. Can be called at
    ...
    {
        collating_function func = [](int leftLength,
                                     const void* lhs,
                                     int rightLength,
                                     const void* rhs)
        {
    ...
    {
        return {
            other.get_connection(), "main", this->get_connection(), "main", {}};
    }
    ...
    {
        return {
            this->get_connection(), "main", other.get_connection(), "main", {}};
    }
    ...
    int busy_handler(std::function<int(int)> handler)
    {
        ...
        if (this->is_opened()) {
            if (_busy_handler) {
                ...
                return sqlite3_busy_handler(
                    this->connection->get(), nullptr, nullptr);
            }
        } else {
            return SQLITE_OK;
        }
  ...
  protected:
    ...
    void on_open_internal(sqlite3* db)
    {
        ...
        for (auto& functionPointer : this->scalarFunctions) {
            try_to_create_function(
                db, static_cast<scalar_function_t&>(*functionPointer));
        }

        for (auto& functionPointer : this->aggregateFunctions) {
            try_to_create_function(
                db, static_cast<aggregate_function_t&>(*functionPointer));
        }
    ...
    {
        auto it = find_if(functionsVector.begin(),
                          functionsVector.end(),
        ...
        if (it != functionsVector.end()) {
            ...
            throw std::system_error(
                std::make_error_code(orm_error_code::function_not_found));
        }
    }
                                                 ...
                                                 sqlite3_value** values)
    {
        ...
        auto functionPointer =
            static_cast<aggregate_function_t*>(functionVoidPointer);
        ...
        functionPointer->step(
            context, *aggregateContextIntPointer, argsCount, values);
    }
    ...
    static void scalar_function_callback(sqlite3_context* context,
                                         int argsCount,
                                         sqlite3_value** values)
    {
        auto functionVoidPointer = sqlite3_user_data(context);
        auto functionPointer =
            static_cast<scalar_function_t*>(functionVoidPointer);
    ...
    static int collate_callback(
        void* arg, int leftLen, const void* lhs, int rightLen, const void* rhs)
    {
...
struct column_names_getter
{
    ...
    template<class C>
    std::vector<std::string> operator()(const expression_type& t,
                                        const C& context)
    {
...
struct column_names_getter<std::reference_wrapper<T>, void>
{
    ...
    template<class C>
    std::vector<std::string> operator()(const expression_type& expression,
                                        const C& context)
    {
...
struct column_names_getter<columns_t<Args...>, void>
{
    ...
    template<class C>
    std::vector<std::string> operator()(const expression_type& cols,
                                        const C& context)
    {
        std::vector<std::string> columnNames;
        ...
        auto newContext = context;
        newContext.skip_table_name = false;
        iterate_tuple(cols.columns,
                      [&columnNames, &newContext](auto& m)
                      {
...
struct statement_serializator<excluded_t<T>, void>
{
    ...
    std::string operator()(const statement_type& statement, const C& context)
    {
        std::stringstream ss;
        ss << "excluded.";
        if (auto columnNamePointer =
                context.impl.column_name(statement.expression)) {
    ...
    void>
{
                           ...
                           const C& context) const
    {
        std::stringstream ss;
        ss << "ON CONFLICT";
        iterate_tuple(statement.target_args,
                      [&ss, &context](auto& value)
                      {
                          using value_type =
                              typename std::decay<decltype(value)>::type;
                          auto needParenthesis =
                              std::is_member_pointer<value_type>::value;
                          ss << ' ';
                          if (needParenthesis) {
                              ss << '(';
                          }
        ...
        if (std::tuple_size<typename statement_type::actions_tuple>::value == 0)
        {
            ...
            iterate_tuple(statement.actions,
                          [&ss, &updateContext](auto& value)
...
struct statement_serializator<built_in_function_t<R, S, Args...>, void>
{
                           ...
                           const C& context) const
    {
        ...
        using args_type =
            typename std::decay<decltype(statement)>::type::args_type;
        args.reserve(std::tuple_size<args_type>::value);
        iterate_tuple(statement.args,
                      [&args, &context](auto& v)
    ...
    void>
{
    ...
    std::string operator()(const statement_type& fk, const C& context) const
    {
        ...
        referencesNames.reserve(referencesCount);
        {
            ...
            auto refTableName = context.impl.find_table_name(
                typeid(first_reference_mapped_type));
            ss << '\'' << refTableName << '\'';
        }
        iterate_tuple(
            fk.references,
            [&referencesNames, &context](auto& v)
            {
                if (auto columnNamePointer = context.impl.column_name(v)) {
...
struct statement_serializator<check_t<T>, void>
{
    ...
    {
        return static_cast<std::string>(c) + " "
            + serialize(c.expression, context);
    }
};
        ...
        ss << type_printer<field_type>().print() << " ";
        {
            ...
            iterate_tuple(
                 ...
                 &context](auto& v)
                {
                    ...
                    } else if (std::is_same<autoincrement_t,
...
struct statement_serializator<insert_explicit<T, Cols...>, void>
{
    ...
    std::string operator()(const statement_type& ins, const C& context) const
    {
        ...
        using object_type =
            typename expression_object_type<expression_type>::type;
        ...
        columnNames.reserve(colsCount);
        {
            ...
            iterate_tuple(ins.columns.columns,
                          [&columnNames, &columnsContext](auto& m)
                          {
...
struct statement_serializator<set_t<Args...>, void>
{
                           ...
                           const C& context) const
    {
        ...
        auto assignsCount =
            std::tuple_size<typename statement_type::assigns_type>::value;
        ...
        iterate_tuple(statement.assigns,
                      [&ss, &context, &leftContext, &assignIndex, assignsCount](
                          auto& value)
                      {
    ...
    std::string operator()(const statement_type& upd, const C& context) const
    {
        ...
        if (!collector.table_names.empty()) {
            if (collector.table_names.size() == 1) {
                ...
                auto leftContext = context;
                leftContext.skip_table_name = true;
                iterate_tuple(upd.set.assigns,
                              [&context, &leftContext, &setPairs](auto& asgn)
                              {
...
template<class T, class C>
std::string serialize_insert_range_impl(const T& /*statement*/,
                                        const C& context,
                                        const int valuesCount)
{
    ...
    tImpl.table.for_each_column(
        [&columnNames, &compositeKeyColumnNames](auto& c)
        {
            using table_type = typename std::decay<decltype(tImpl.table)>::type;
            if (table_type::is_without_rowid
                || !c.template has<primary_key_t<>>()) {
                auto it = find(compositeKeyColumnNames.begin(),
    ...
    if (columnNamesCount) {
        ...
        throw std::system_error(
            std::make_error_code(orm_error_code::cannot_use_default_value));
    }
...
struct statement_serializator<columns_t<Args...>, void>
{
                           ...
                           const C& context) const
    {
        ...
        iterate_tuple(
            statement.columns,
            [&context, &ss, &index](auto& value)
            {
                ss << serialize(value, context);
                if (index
                    < int(std::tuple_size<std::tuple<Args...>>::value) - 1) {
                    ss << ", ";
                }
                ++index;
            });
...
struct statement_serializator<
    T,
    typename std::enable_if<is_insert_raw<T>::value
                            || is_replace_raw<T>::value>::type>
{
    using statement_type = T;
                           ...
                           const C& context) const
    {
        ...
        iterate_tuple(statement.args,
                      [&context, &ss](auto& value)
                      {
                          ...
                          } else if (is_values<value_type>::value
                                     || is_select<value_type>::value) {
                              auto newContext = context;
                              newContext.use_parentheses = false;
                              ss << serialize(value, newContext);
                          } else {
...
template<class T, class C>
std::string serialize_replace_range_impl(const T& rep,
                                         const C& context,
                                         const int valuesCount)
{
...
struct statement_serializator<insert_range_t<It, L, O>, void>
{
    ...
    std::string operator()(const statement_type& statement,
                           const C& context) const
    {
        const auto valuesCount = static_cast<int>(
...
std::string serialize_get_all_impl(const T& get, const C& context)
{
    ...
    iterate_tuple(get.conditions,
                  [&context, &ss](auto& v) { ss << serialize(v, context); });
    return ss.str();
}
...
struct statement_serializator<index_t<Cols...>, void>
{
                           ...
                           const C& context) const
    {
        ...
        std::vector<std::string> columnNames;
        iterate_tuple(statement.columns,
                      [&columnNames, &context](auto& v)
                      {
...
struct statement_serializator<from_t<Args...>, void>
{
                           ...
                           const C& context) const
    {
        ...
        size_t index = 0;
        iterate_tuple<tuple>(
            [&context, &ss, &index](auto* itemPointer)
            {
                using mapped_type =
                    typename std::remove_pointer<decltype(itemPointer)>::type;

                auto aliasString = alias_extractor<mapped_type>::get();
                ss << "'"
                   << context.impl.find_table_name(
                          typeid(typename mapped_type_proxy<mapped_type>::type))
                   << "'";
...
struct statement_serializator<multi_order_by_t<Args...>, void>
{
                           ...
                           const C& context) const
    {
        std::stringstream ss;
        std::vector<std::string> expressions;
        iterate_tuple(orderBy.args,
                      [&expressions, &context](auto& v)
                      {
...
struct statement_serializator<group_by_t<Args...>, void>
{
    ...
    template<class C>
    std::string operator()(const statement_type& groupBy,
                           const C& context) const
    {
        std::stringstream ss;
        std::vector<std::string> expressions;
        auto newContext = context;
        newContext.skip_table_name = false;
        iterate_tuple(groupBy.args,
                      [&expressions, &newContext](auto& v)
                      {
...
struct statement_serializator<std::tuple<Args...>, void>
{
                           ...
                           const C& context) const
    {
        ...
        iterate_tuple(statement,
                      [&context, &index, &ss](auto& value)
                      {
                          ss << serialize(value, context);
...
struct storage_t : storage_base
{
  ...
  protected:
                      ...
                      const I& tableImpl)
    {
        ...
        iterate_tuple(tableImpl.table.columns,
    ...
    {
        //  here we copy source table to another with a name with '_backup'
        //  suffix, but in case table with such a name already exists we append
        //  suffix 1, then 2, etc until we find a free name..
    ...
    void assert_insertable_type() const
    {
        ...
        using table_type = typename std::decay<decltype(tImpl.table)>::type;
        using columns_type =
            typename std::decay<decltype(tImpl.table.columns)>::type;

        using bool_type =
            std::integral_constant<bool, table_type::is_without_rowid>;
        ...
        static_if<bool_type {}>(
            ...
            [](auto& tImpl)
            {
                std::ignore = tImpl;
                static_assert(
                    count_tuple<columns_type,
                                is_column_with_insertable_primary_key>::value
                        <= 1,
                    "Attempting to execute 'insert' request into an "
                    "noninsertable "
                    "table was detected. "
                    "Insertable table cannot contain > 1 primary keys. Please "
                    "use "
                    "'replace' instead of "
                    "'insert', or you can use 'insert' with explicit column "
                    "listing.");
                static_assert(
                    count_tuple<columns_type,
                                is_column_with_noninsertable_primary_key>::value
                        == 0,
                    "Attempting to execute 'insert' request into an "
                    "noninsertable "
                    "table was detected. "
                    "Insertable table cannot contain non-standard primary "
                    "keys. "
                    "Please use 'replace' instead "
                    "of 'insert', or you can use 'insert' with explicit column "
                    "listing.");

                // unfortunately, this static_assert's can't see an composite
                // keys((
            })(tImpl);
    }
  ...
  public:
    ...
    void remove_all(Args&&... args)
    {
        ...
        auto statement = this->prepare(
            sqlite_orm::remove_all<O>(std::forward<Args>(args)...));
     ...
     * equal. O is an object type. May be not specified explicitly cause it can
     * be deduced by compiler from first parameter.
  ...
  protected:
    ...
    std::string group_concat_internal(F O::*m,
  ...
  public:
     ...
     * `std::vector`.
     *  @note If you need to return the result in a different container type
     * then use a different `get_all` function overload `get_all<User,
     * std::list<User>>`
     ...
     *  @example: storage.get_all<User, std::list<User>>(); - SELECT * FROM
     * users
    ...
    auto get_all(Args&&... args)
    {
        this->assert_mapped_type<O>();
        auto statement = this->prepare(
            sqlite_orm::get_all<O, R>(std::forward<Args>(args)...));
        return this->execute(statement);
    }
     ...
     *  @note If you need to return the result in a different container type
     * then use a different `get_all_pointer` function overload
     * `get_all_pointer<User, std::list<User>>`
     ...
     *  @return All objects of type O as std::unique_ptr<O> stored in database
     * at the moment.
     ...
     *  throws std::system_error(orm_error_code::not_found, orm_error_category)
     * if object not found with given id. throws std::system_error with
     ...
     * `std::system_error(orm_error_code::not_found, orm_error_category)` if
    ...
    /**
     *  The same as `get` function but doesn't throw an exception if noting
     * found but returns std::unique_ptr with null value. throws
     * std::system_error in case of db error.
     */
    template<class O, class... Ids>
    std::unique_ptr<O> get_pointer(Ids... ids)
    {
        this->assert_mapped_type<O>();
        auto statement = this->prepare(
            sqlite_orm::get_pointer<O>(std::forward<Ids>(ids)...));
        return this->execute(statement);
    }
    ...
    /**
     *  The same as `get` function but doesn't throw an exception if noting
     * found but returns an empty std::optional. throws std::system_error in
     * case of db error.
     */
    template<class O, class... Ids>
    std::optional<O> get_optional(Ids... ids)
    {
        this->assert_mapped_type<O>();
        auto statement = this->prepare(
            sqlite_orm::get_optional<O>(std::forward<Ids>(ids)...));
        return this->execute(statement);
    }
#endif  // SQLITE_ORM_OPTIONAL_SUPPORTED
    ...
    int count(F O::*m, Args&&... args)
    {
        this->assert_mapped_type<O>();
        auto rows =
            this->select(sqlite_orm::count(m), std::forward<Args>(args)...);
        if (!rows.empty()) {
            return rows.front();
        } else {
            return 0;
     ...
     *  @param m is a class member pointer (the same you passed into
     * make_column).
    ...
    double avg(F O::*m, Args&&... args)
    {
        this->assert_mapped_type<O>();
        auto rows =
            this->select(sqlite_orm::avg(m), std::forward<Args>(args)...);
        if (!rows.empty()) {
            return rows.front();
        } else {
            return 0;
    ...
    std::unique_ptr<Ret> max(F O::*m, Args&&... args)
    {
        this->assert_mapped_type<O>();
        auto rows =
            this->select(sqlite_orm::max(m), std::forward<Args>(args)...);
        if (!rows.empty()) {
    ...
    std::unique_ptr<Ret> min(F O::*m, Args&&... args)
    {
        this->assert_mapped_type<O>();
        auto rows =
            this->select(sqlite_orm::min(m), std::forward<Args>(args)...);
        if (!rows.empty()) {
            return std::move(rows.front());
        } else {
            return {};
    ...
    double total(F O::*m, Args&&... args)
    {
        this->assert_mapped_type<O>();
        auto rows =
            this->select(sqlite_orm::total(m), std::forward<Args>(args)...);
        if (!rows.empty()) {
            return std::move(rows.front());
        } else {
            return {};
     ...
     */
    template<class O>
    typename std::enable_if<storage_traits::type_is_mapped<self, O>::value,
                            std::string>::type
    dump(const O& o)
    {
        auto& tImpl = this->get_impl<O>();
    ...
    void replace_range(It from, It to, L transformer)
    {
        ...
        auto statement = this->prepare(
            sqlite_orm::replace_range<T>(from, to, std::move(transformer)));
        this->execute(statement);
    }
    ...
    int insert(const O& o)
    {
        ...
        return call_insert_impl_and_catch_constraint_failed(
            [this, &o]()
            {
     ...
     * This insert is designed to be able to call any type of `INSERT` query
     * with no limitations.
     *  @example
     *  ```sql
     *  INSERT INTO users (id, name) VALUES(5, 'Little Mix')
    ...
    /**
     *  Raw replace statement creation routine. Use this if `replace` with
     * object does not fit you. This replace is designed to be able to call any
     * type of `REPLACE` query with no limitations. Actually this is the same
     * query as raw insert except `OR...` option existance.
     *  @example
     *  ```sql
     *  REPLACE INTO users (id, name) VALUES(5, 'Little Mix')
     *  ```
    ...
    void insert_range(It from, It to)
    {
        ...
        call_insert_impl_and_catch_constraint_failed(
            [this, from, to]()
            {
                auto statement =
                    this->prepare(sqlite_orm::insert_range(from, to));
                this->execute(statement);
            });
    }
    ...
    void insert_range(It from, It to, L transformer)
    {
        ...
        call_insert_impl_and_catch_constraint_failed(
            [this, from, to, transformer = std::move(transformer)]()
            {
                auto statement = this->prepare(sqlite_orm::insert_range<T>(
                    from, to, std::move(transformer)));
                this->execute(statement);
            });
    }
  ...
  protected:
    ...
    sync_schema_result schema_status(
        const storage_impl<index_t<Cols...>, Tss...>&, sqlite3*, bool)
    {
    ...
    sync_schema_result schema_status(
        const storage_impl<TTable<Cs...>, Tss...>& tImpl,
        sqlite3* db,
        bool preserve)
    {
        ...
        if (schema_stat != decltype(schema_stat)::already_in_sync) {
            if (schema_stat == decltype(schema_stat)::new_table_created) {
                            ...
                            new_columns_added_and_old_columns_removed)
                {
                    ...
                    //  now get current table info from db using `PRAGMA
                    //  table_info` query..
                    auto dbTableInfo =
                        tImpl.get_table_info(tImpl.table.name, db);

                    //  this vector will contain pointers to columns that gotta
                    //  be added..
                    std::vector<table_info*> columnsToAdd;
    ...
    prepared_statement_t<S> prepare_impl(S statement)
    {
        ...
        if (sqlite3_prepare_v2(db, query.c_str(), -1, &stmt, nullptr)
            == SQLITE_OK) {
            return prepared_statement_t<S> {
                std::forward<S>(statement), stmt, con};
        } else {
            throw std::system_error(
                std::error_code(sqlite3_errcode(db),
                                get_sqlite_error_category()),
  ...
  public:
     ...
     * db and
     *          * if there are columns in db that do not exist in storage
     * (excess) table will be dropped and recreated
     ...
     * make db schema the same as you specified in `make_storage` function call.
     * A good point is that if you have no db file at all it will be created and
     * all tables also will be created with exact tables and columns you
     * specified in `make_storage`, `make_table` and `make_column` call. The
     * best practice is to call this function right after storage creation.
    ...
    std::map<std::string, sync_schema_result> sync_schema(bool preserve = false)
    {
        ...
        auto db = con.get();
        this->impl.for_each(
            [&result, db, preserve, this](auto& tableImpl)
            {
        ...
        bool preserve = false)
    {
        ...
        this->impl.for_each(
            ...
            {
                auto schemaStatus =
                    this->schema_status(tableImpl, db, preserve);
    ...
    {
        return prepare_impl<update_all_t<set_t<Args...>, Wargs...>>(
            std::move(upd));
    }
    ...
    {
        using object_type =
            typename expression_object_type<decltype(ins)>::type;
    ...
    {
        using object_type =
            typename expression_object_type<decltype(rep)>::type;
        this->assert_mapped_type<object_type>();
        ...
        const prepared_statement_t<insert_explicit<T, Cols...>>& statement)
    {
        ...
        sqlite3_reset(stmt);
        iterate_tuple(
            statement.t.columns.columns,
            [&o, &index, &stmt, &tImpl, db](auto& m)
            {
                using column_type = typename std::decay<decltype(m)>::type;
                using field_type =
                    typename column_result_t<self, column_type>::type;
                const field_type* value =
                    tImpl.table.template get_object_field_pointer<field_type>(
                        o, m);
                if (SQLITE_OK
                    != statement_binder<field_type>().bind(
                        stmt, index++, *value)) {
                    throw std::system_error(
                        std::error_code(sqlite3_errcode(db),
                                        get_sqlite_error_category()),
    ...
    template<
        class T,
        typename std::enable_if<(is_replace_range<T>::value
                                 || is_replace<T>::value)>::type* = nullptr>
    ...
    template<class T,
             typename std::enable_if<(is_insert_range<T>::value
                                      || is_insert<T>::value)>::type* = nullptr>
    int64 execute(const prepared_statement_t<T>& statement)
    {
        ...
        auto compositeKeyColumnNames =
            tImpl.table.composite_key_columns_names();
        sqlite3_reset(stmt);
        auto processObject =
            [&index, &stmt, &tImpl, &compositeKeyColumnNames, db](auto& o)
        {
            tImpl.table.for_each_column(
                [&](auto& c)
                {
                    using table_type =
                        typename std::decay<decltype(tImpl.table)>::type;
                    if (table_type::is_without_rowid
                        || !c.template has<primary_key_t<>>()) {
                        ...
                        if (it == compositeKeyColumnNames.end()) {
                            using column_type =
                                typename std::decay<decltype(c)>::type;
                            using field_type = typename column_type::field_type;
                            if (c.member_pointer) {
                                if (SQLITE_OK
                                    != statement_binder<field_type>().bind(
                                ...
                                using getter_type =
                                    typename column_type::getter_type;
                                field_value_holder<getter_type> valueHolder {
                                    ((o).*(c.getter))()};
                                if (SQLITE_OK
                                    != statement_binder<field_type>().bind(
            ...
            statement)
    {
        ...
        sqlite3_reset(stmt);
        iterate_tuple(
            statement.t.set.assigns,
            [&index, stmt, db](auto& setArg)
            {
                iterate_ast(
                    setArg,
                    [&index, stmt, db](auto& node)
                    {
                        using node_type =
                            typename std::decay<decltype(node)>::type;
                        conditional_binder<node_type, is_bindable<node_type>>
                            binder {stmt, index};
                        if (SQLITE_OK != binder(node)) {
                            throw std::system_error(
        ...
        const prepared_statement_t<select_t<T, Args...>>& statement)
    {
        ...
        do {
            ...
            switch (stepRes) {
                case SQLITE_ROW: {
                    using table_info_pointer_t = typename std::remove_pointer<
                        decltype(tableInfoPointer)>::type;
                    using table_info_t =
                        typename std::decay<table_info_pointer_t>::type;
    ...
    bool has_dependent_rows(const O& object) {
        auto res = false;
        using TupleWithForeignKeyTypes = typename
    storage_traits::storage_fk_references<self, O>::type;
        iterate_tuple<TupleWithForeignKeyTypes>([&res, this](auto *itemPointer){
            using ConstItem = typename
    std::remove_pointer<decltype(itemPointer)>::type; using Item = typename
    std::decay<ConstItem>::type; if(!res) { auto rows =
    this->select(count<Item>()); if (!rows.empty()) { res = rows[0];
                }
            }
        });
        return res;
...
{
    return {filename,
            internal::storage_impl<Ts...>(std::forward<Ts>(tables)...)};
}
    ...
    namespace sqlite_orm
{
            ...
            is_base_of_template<T, binary_condition>::value>::type>
    {
        ...
        using type =
            typename conc_tuple<left_node_tuple, right_node_tuple>::type;
    };
    ...
    struct node_tuple<between_t<A, T>, void>
    {
        ...
        using type = typename conc_tuple<expression_tuple,
                                         lower_tuple,
                                         upper_tuple>::type;
    };
    ...
    struct node_tuple<simple_case_t<R, T, E, Args...>, void>
    {
        ...
        using type =
            typename conc_tuple<case_tuple, args_tuple, else_tuple>::type;
    };
...
template<int N, class T, class... Ids>
const auto& get(
    const internal::prepared_statement_t<internal::get_t<T, Ids...>>& statement)
{
    return internal::get_ref(std::get<N>(statement.t.ids));
}
...
const auto& get(const internal::prepared_statement_t<T>& statement)
{
    ...
    using result_tupe =
        typename std::tuple_element<static_cast<size_t>(N), bind_tuple>::type;
    const result_tupe* result = nullptr;
    auto index = -1;
    internal::iterate_ast(
        statement.t,
        [&result, &index](auto& node)
        {
            using node_type = typename std::decay<decltype(node)>::type;
            ...
            if (index == N) {
                internal::static_if<std::is_same<result_tupe, node_type> {}>(
                    [](auto& r, auto& n) {
                        r = const_cast<
                            typename std::remove_reference<decltype(r)>::type>(
                            &n);
                    })(result, node);
            }
        });
